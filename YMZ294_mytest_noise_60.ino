...
boolean sw1, sw2, sw3, sw4;
  ...
  ymz.SetFrequency(CH_B, CalcFreqByMML(7, 'E'));
  ymz.SetFrequency(CH_C, CalcFreqByMML(7, 'G'));  
  delay(500);
  allzero(); 
  }
  if(sw2==0){
  ...
  ymz.SetFrequency(CH_B, CalcFreqByMML(7, 'F'));
  ymz.SetFrequency(CH_C, CalcFreqByMML(7, 'A'));  
  delay(500);
  allzero();
  }
  if(sw3==0){
  ...
  ymz.SetFrequency(CH_C, CalcFreqByMML(7, 'B'));  
  delay(500);
  allzero();  
  }
  if(sw4==0){
  ...
  ymz.SetFrequency(CH_C, CalcFreqByMML(8, 'C'));
  delay(500);
  allzero();  
  }  
}
