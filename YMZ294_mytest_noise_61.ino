...
boolean sw1, sw2, sw3, sw4;
  ...
  ymz.SetFrequency(CH_B, CalcFreqByMML(7, 'C')-10);
  ymz.SetFrequency(CH_C, CalcFreqByMML(7, 'C')+10);  
  delay(500);
  allzero(); 
  }
  if(sw2==0){
  ...
  ymz.SetFrequency(CH_B, CalcFreqByMML(7, 'D')-10);
  ymz.SetFrequency(CH_C, CalcFreqByMML(7, 'D')+10);  
  delay(500);
  allzero();
  }
  if(sw3==0){
  ...
  ymz.SetFrequency(CH_B, CalcFreqByMML(7, 'E')-10);
  ymz.SetFrequency(CH_C, CalcFreqByMML(7, 'E')+10);  
  delay(500);
  allzero();  
  }
  if(sw4==0){
  ...
  ymz.SetFrequency(CH_B, CalcFreqByMML(7, 'F')-10);
  ymz.SetFrequency(CH_C, CalcFreqByMML(7, 'F')+10);
  delay(500);
  allzero();  
  }  
}
