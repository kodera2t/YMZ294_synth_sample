...
int val1, val2;
  ...
  ymz.SetFrequency(CH_B, val1/2-i);
  ymz.SetFrequency(CH_C, abs(val1/4-i));  
  }
  allzero(); 
  }
  if(sw2==0){
  ...
  ymz.SetFrequency(CH_A, i);
  ymz.SetFrequency(CH_B, val2-i);
  ymz.SetFrequency(CH_C, abs(val2/2-i));  
  }
  allzero();
  }
  if(sw3==0){
  allon();
  for(int i=1;i<val1*4;i++){
  ymz.SetFrequency(CH_A, i);
  ymz.SetFrequency(CH_B, val1*2-i);
  ymz.SetFrequency(CH_C, abs(val1-i));  
  }
  allzero();  
  }
  if(sw4==0){
  ...
  for(int i=1;i<val1*4;i++){
  ymz.SetFrequency(CH_A, i);
  ymz.SetFrequency(CH_B, val1*4-i);
  ymz.SetFrequency(CH_C, abs(val1*2-i));  
  }
  allzero();  
  }  
}
