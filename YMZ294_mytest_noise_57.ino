...
boolean sw1, sw2, sw3, sw4;
  ...
  ymz.SetFrequency(CH_B, CalcFreqByMML(6, 'E'));
  ymz.SetFrequency(CH_C, CalcFreqByMML(6, 'G'));
  delay(200);
  allzero();  
  }
  if(sw2==0){
  ...
  ymz.SetFrequency(CH_C, CalcFreqByMML(6, 'A'));
  delay(200);  
  allzero();
  }
  if(sw3==0){
  ...
  ymz.SetFrequency(CH_B, CalcFreqByMML(6, 'G'));
  ymz.SetFrequency(CH_C, CalcFreqByMML(6, 'B'));
  delay(200); 
  allzero();  
  }
  if(sw4==0){
  ...
  ymz.SetFrequency(CH_B, CalcFreqByMML(6, 'A'));
  ymz.SetFrequency(CH_C, CalcFreqByMML(7, 'C'));
  delay(200);
  allzero();  
  }  
}
